...
#define CLKID_CPU_CLK_DYN			(CPU_BASE + 0)
#define CLKID_CPU_CLK_DIV16_EN			(CPU_BASE + 1)
#define CLKID_CPU_CLK_DIV16			(CPU_BASE + 2)
#define CLKID_CPU_CLK_APB_DIV			(CPU_BASE + 3)
#define CLKID_CPU_CLK_APB			(CPU_BASE + 4)
#define CLKID_CPU_CLK_ATB_DIV			(CPU_BASE + 5)
#define CLKID_CPU_CLK_ATB			(CPU_BASE + 6)
#define CLKID_CPU_CLK_AXI_DIV			(CPU_BASE + 7)
#define CLKID_CPU_CLK_AXI			(CPU_BASE + 8)
#define CLKID_CPU_CLK_TRACE_DIV			(CPU_BASE + 9)
#define CLKID_CPU_CLK_TRACE			(CPU_BASE + 10)
#define CLKID_CPU_CLK				(CPU_BASE + 11)
#define CLKID_DSU_CLK_DYN			(CPU_BASE + 12)
#define CLKID_DSU_CLK_FINAL			(CPU_BASE + 13)
#define CLKID_DSU_CLK				(CPU_BASE + 14)
/* Media clocks */
#define MEDIA_BASE				(CPU_BASE + 15)
