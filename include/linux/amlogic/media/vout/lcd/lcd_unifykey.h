...
#define LCD_UNIFYKEY_WAIT_TIMEOUT      16000
#define LCD_UNIFYKEY_RETRY_INTERVAL    10   /* ms */
...
#define LCD_UKEY_LDIM_DEV_CUST_ATTR_0      (LCD_UKEY_LDIM_DEV_NAME + 681)	//mcu header
#define LCD_UKEY_LDIM_DEV_CUST_ATTR_1      (LCD_UKEY_LDIM_DEV_NAME + 685)	//mcu adim/pdim
