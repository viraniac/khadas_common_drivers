...
static struct ddr_port_desc ddr_port_desc_t3x[] __initdata = {
	...
	/* NIC_SYS */
	{ .port_id = 16, .port_name = "AOCPU"         },
	{ .port_id = 19, .port_name = "I2C_MONITOR"   },
	{ .port_id = 21, .port_name = "SPI_SG0"       },
	{ .port_id = 22, .port_name = "SPI_SG1"       },
	{ .port_id = 23, .port_name = "USB3_B"        },
	{ .port_id = 32, .port_name = "AUDMA"         },
	{ .port_id = 33, .port_name = "AUDIO"         },
	{ .port_id = 35, .port_name = "SDEMMCA"       },
	{ .port_id = 36, .port_name = "SDEMMCB"       },
	{ .port_id = 37, .port_name = "SDEMMCC"       },
	{ .port_id = 38, .port_name = "DMA"           },
	{ .port_id = 54, .port_name = "DEMUX"         },
	{ .port_id = 56, .port_name = "HDMIRX"        },
	{ .port_id = 57, .port_name = "USB3_A"        },
	{ .port_id = 58, .port_name = "USB2"          },
	{ .port_id = 59, .port_name = "PCIE0"         },
	{ .port_id = 60, .port_name = "DSPA"          },
	{ .port_id = 61, .port_name = "JTAG"          },
	{ .port_id = 62, .port_name = "ETH"           },
	{ .port_id = 63, .port_name = "TVFE"          },
	/* NIC_VPU */
	{ .port_id = 64, .port_name = "VPU0"          },
	{ .port_id = 66, .port_name = "VPU1"          },
	{ .port_id = 68, .port_name = "VPU2"          },
	...
	{ .port_id = 104, .port_name = "GE2D"          },
	{ .port_id = 106, .port_name = "VIDEO_CMPR"    },
	{ .port_id = 116, .port_name = "DEMOD"         },
	/* NIC_FRC*/
	{ .port_id = 117, .port_name = "FRC0"          },
	{ .port_id = 119, .port_name = "FRC1"          },
	{ .port_id = 121, .port_name = "FRC2"          },
	{ .port_id = 123, .port_name = "FRC3"          }
};
...
static struct ddr_port_desc ddr_port_desc_txhd2[] __initdata = {
	...
	{ .port_id = 35, .port_name = "ARB0"          },
	{ .port_id = 38, .port_name = "AUDIO"         },
	{ .port_id = 39, .port_name = "AFIFO"         },
	{ .port_id = 40, .port_name = "PARSER1"       },
	{ .port_id = 41, .port_name = "PARSER0"       },
	{ .port_id = 42, .port_name = "AOCPU"         },
	{ .port_id = 43, .port_name = "SDEMMCC"       },
	{ .port_id = 44, .port_name = "SPICC"         },
