...
static int t5m_dmc_mon_irq(struct dmc_monitor *mon, void *data, char clear)
{
	unsigned long irqreg;
	struct dmc_mon_comm *mon_comm = (struct dmc_mon_comm *)data;
...
static void t5m_dmc_vio_to_port(void *data, unsigned long *vio_bit)
{
...
static int t5m_reg_analysis(char *input, char *output)
{
