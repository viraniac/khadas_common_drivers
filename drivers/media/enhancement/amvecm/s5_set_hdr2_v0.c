		    ...
		    enum vpp_index_e vpp_index)
{
	...
	if (module_sel == VD1_HDR) {
		...
		MATRIXI_COEF00_01 = T3X_OSD2_HDR2_MATRIXI_COEF00_01;
		MATRIXI_COEF00_01 = T3X_OSD2_HDR2_MATRIXI_COEF00_01;
		MATRIXI_COEF02_10 = T3X_OSD2_HDR2_MATRIXI_COEF02_10;
		MATRIXI_COEF11_12 = T3X_OSD2_HDR2_MATRIXI_COEF11_12;
		MATRIXI_COEF20_21 = T3X_OSD2_HDR2_MATRIXI_COEF20_21;
		MATRIXI_COEF22 = T3X_OSD2_HDR2_MATRIXI_COEF22;
		MATRIXI_COEF30_31 = T3X_OSD2_HDR2_MATRIXI_COEF30_31;
		MATRIXI_COEF32_40 = T3X_OSD2_HDR2_MATRIXI_COEF32_40;
		MATRIXI_COEF41_42 = T3X_OSD2_HDR2_MATRIXI_COEF41_42;
		MATRIXI_OFFSET0_1 = T3X_OSD2_HDR2_MATRIXI_OFFSET0_1;
		MATRIXI_OFFSET2 = T3X_OSD2_HDR2_MATRIXI_OFFSET2;
		MATRIXI_PRE_OFFSET0_1 = T3X_OSD2_HDR2_MATRIXI_PRE_OFFSET0_1;
		MATRIXI_PRE_OFFSET2 = T3X_OSD2_HDR2_MATRIXI_PRE_OFFSET2;
		MATRIXI_CLIP = T3X_OSD2_HDR2_MATRIXI_CLIP;
		MATRIXI_EN_CTRL = T3X_OSD2_HDR2_MATRIXI_EN_CTRL;

		MATRIXO_COEF00_01 = T3X_OSD2_HDR2_MATRIXO_COEF00_01;
		MATRIXO_COEF00_01 = T3X_OSD2_HDR2_MATRIXO_COEF00_01;
		MATRIXO_COEF02_10 = T3X_OSD2_HDR2_MATRIXO_COEF02_10;
		MATRIXO_COEF11_12 = T3X_OSD2_HDR2_MATRIXO_COEF11_12;
		MATRIXO_COEF20_21 = T3X_OSD2_HDR2_MATRIXO_COEF20_21;
		MATRIXO_COEF22 = T3X_OSD2_HDR2_MATRIXO_COEF22;
		MATRIXO_COEF30_31 = T3X_OSD2_HDR2_MATRIXO_COEF30_31;
		MATRIXO_COEF32_40 = T3X_OSD2_HDR2_MATRIXO_COEF32_40;
		MATRIXO_COEF41_42 = T3X_OSD2_HDR2_MATRIXO_COEF41_42;
		MATRIXO_OFFSET0_1 = T3X_OSD2_HDR2_MATRIXO_OFFSET0_1;
		MATRIXO_OFFSET2 = T3X_OSD2_HDR2_MATRIXO_OFFSET2;
		MATRIXO_PRE_OFFSET0_1 = T3X_OSD2_HDR2_MATRIXO_PRE_OFFSET0_1;
		MATRIXO_PRE_OFFSET2 = T3X_OSD2_HDR2_MATRIXO_PRE_OFFSET2;
		MATRIXO_CLIP = T3X_OSD2_HDR2_MATRIXO_CLIP;
		MATRIXO_EN_CTRL = T3X_OSD2_HDR2_MATRIXO_EN_CTRL;

		CGAIN_OFFT = T3X_OSD2_HDR2_CGAIN_OFFT;
		CGAIN_COEF0 = T3X_OSD2_HDR2_CGAIN_COEF0;
		CGAIN_COEF1 = T3X_OSD2_HDR2_CGAIN_COEF1;
		ADPS_CTRL = T3X_OSD2_HDR2_ADPS_CTRL;
		ADPS_ALPHA0 = T3X_OSD2_HDR2_ADPS_ALPHA0;
		ADPS_ALPHA1 = T3X_OSD2_HDR2_ADPS_ALPHA1;
		ADPS_BETA0 = T3X_OSD2_HDR2_ADPS_BETA0;
		ADPS_BETA1 = T3X_OSD2_HDR2_ADPS_BETA1;
		ADPS_BETA2 = T3X_OSD2_HDR2_ADPS_BETA2;
		ADPS_COEF0 = T3X_OSD2_HDR2_ADPS_COEF0;
		ADPS_COEF1 = T3X_OSD2_HDR2_ADPS_COEF1;
		GMUT_CTRL = T3X_OSD2_HDR2_GMUT_CTRL;
		GMUT_COEF0 = T3X_OSD2_HDR2_GMUT_COEF0;
		GMUT_COEF1 = T3X_OSD2_HDR2_GMUT_COEF1;
		GMUT_COEF2 = T3X_OSD2_HDR2_GMUT_COEF2;
		GMUT_COEF3 = T3X_OSD2_HDR2_GMUT_COEF3;
		GMUT_COEF4 = T3X_OSD2_HDR2_GMUT_COEF4;

		hdr_ctrl = T3X_OSD2_HDR2_CTRL;
		hdr_clk_gate = T3X_OSD2_HDR2_CLK_GATE;
	} else if (module_sel == VDIN0_HDR) {
		MATRIXI_COEF00_01 = T3X_VDIN0_HDR2_MATRIXI_COEF00_01;
		MATRIXI_COEF00_01 = T3X_VDIN0_HDR2_MATRIXI_COEF00_01;
		MATRIXI_COEF02_10 = T3X_VDIN0_HDR2_MATRIXI_COEF02_10;
		MATRIXI_COEF11_12 = T3X_VDIN0_HDR2_MATRIXI_COEF11_12;
		MATRIXI_COEF20_21 = T3X_VDIN0_HDR2_MATRIXI_COEF20_21;
		MATRIXI_COEF22 = T3X_VDIN0_HDR2_MATRIXI_COEF22;
		MATRIXI_COEF30_31 = T3X_VDIN0_HDR2_MATRIXI_COEF30_31;
		MATRIXI_COEF32_40 = T3X_VDIN0_HDR2_MATRIXI_COEF32_40;
		MATRIXI_COEF41_42 = T3X_VDIN0_HDR2_MATRIXI_COEF41_42;
		MATRIXI_OFFSET0_1 = T3X_VDIN0_HDR2_MATRIXI_OFFSET0_1;
		MATRIXI_OFFSET2 = T3X_VDIN0_HDR2_MATRIXI_OFFSET2;
		MATRIXI_PRE_OFFSET0_1 = T3X_VDIN0_HDR2_MATRIXI_PRE_OFFSET0_1;
		MATRIXI_PRE_OFFSET2 = T3X_VDIN0_HDR2_MATRIXI_PRE_OFFSET2;
		MATRIXI_CLIP = T3X_VDIN0_HDR2_MATRIXI_CLIP;
		MATRIXI_EN_CTRL = T3X_VDIN0_HDR2_MATRIXI_EN_CTRL;

		MATRIXO_COEF00_01 = T3X_VDIN0_HDR2_MATRIXO_COEF00_01;
		MATRIXO_COEF00_01 = T3X_VDIN0_HDR2_MATRIXO_COEF00_01;
		MATRIXO_COEF02_10 = T3X_VDIN0_HDR2_MATRIXO_COEF02_10;
		MATRIXO_COEF11_12 = T3X_VDIN0_HDR2_MATRIXO_COEF11_12;
		MATRIXO_COEF20_21 = T3X_VDIN0_HDR2_MATRIXO_COEF20_21;
		MATRIXO_COEF22 = T3X_VDIN0_HDR2_MATRIXO_COEF22;
		MATRIXO_COEF30_31 = T3X_VDIN0_HDR2_MATRIXO_COEF30_31;
		MATRIXO_COEF32_40 = T3X_VDIN0_HDR2_MATRIXO_COEF32_40;
		MATRIXO_COEF41_42 = T3X_VDIN0_HDR2_MATRIXO_COEF41_42;
		MATRIXO_OFFSET0_1 = T3X_VDIN0_HDR2_MATRIXO_OFFSET0_1;
		MATRIXO_OFFSET2 = T3X_VDIN0_HDR2_MATRIXO_OFFSET2;
		MATRIXO_PRE_OFFSET0_1 = T3X_VDIN0_HDR2_MATRIXO_PRE_OFFSET0_1;
		MATRIXO_PRE_OFFSET2 = T3X_VDIN0_HDR2_MATRIXO_PRE_OFFSET2;
		MATRIXO_CLIP = T3X_VDIN0_HDR2_MATRIXO_CLIP;
		MATRIXO_EN_CTRL = T3X_VDIN0_HDR2_MATRIXO_EN_CTRL;

		CGAIN_OFFT = T3X_VDIN0_HDR2_CGAIN_OFFT;
		CGAIN_COEF0 = T3X_VDIN0_HDR2_CGAIN_COEF0;
		CGAIN_COEF1 = T3X_VDIN0_HDR2_CGAIN_COEF1;
		ADPS_CTRL = T3X_VDIN0_HDR2_ADPS_CTRL;
		ADPS_ALPHA0 = T3X_VDIN0_HDR2_ADPS_ALPHA0;
		ADPS_ALPHA1 = T3X_VDIN0_HDR2_ADPS_ALPHA1;
		ADPS_BETA0 = T3X_VDIN0_HDR2_ADPS_BETA0;
		ADPS_BETA1 = T3X_VDIN0_HDR2_ADPS_BETA1;
		ADPS_BETA2 = T3X_VDIN0_HDR2_ADPS_BETA2;
		ADPS_COEF0 = T3X_VDIN0_HDR2_ADPS_COEF0;
		ADPS_COEF1 = T3X_VDIN0_HDR2_ADPS_COEF1;
		GMUT_CTRL = T3X_VDIN0_HDR2_GMUT_CTRL;
		GMUT_COEF0 = T3X_VDIN0_HDR2_GMUT_COEF0;
		GMUT_COEF1 = T3X_VDIN0_HDR2_GMUT_COEF1;
		GMUT_COEF2 = T3X_VDIN0_HDR2_GMUT_COEF2;
		GMUT_COEF3 = T3X_VDIN0_HDR2_GMUT_COEF3;
		GMUT_COEF4 = T3X_VDIN0_HDR2_GMUT_COEF4;

		hdr_ctrl = T3X_VDIN0_HDR2_CTRL;
		vpp_sel = 0xff;
		/* hdr_clk_gate = VDIN0_HDR2_CLK_GATE; */
	} else if (module_sel == VDIN1_HDR) {
		if (is_meson_t3x_cpu()) {
			MATRIXI_COEF00_01 = T3X_VDIN1_HDR2_MATRIXI_COEF00_01;
			MATRIXI_COEF00_01 = T3X_VDIN1_HDR2_MATRIXI_COEF00_01;
			MATRIXI_COEF02_10 = T3X_VDIN1_HDR2_MATRIXI_COEF02_10;
			MATRIXI_COEF11_12 = T3X_VDIN1_HDR2_MATRIXI_COEF11_12;
			MATRIXI_COEF20_21 = T3X_VDIN1_HDR2_MATRIXI_COEF20_21;
			MATRIXI_COEF22 = T3X_VDIN1_HDR2_MATRIXI_COEF22;
			MATRIXI_COEF30_31 = T3X_VDIN1_HDR2_MATRIXI_COEF30_31;
			MATRIXI_COEF32_40 = T3X_VDIN1_HDR2_MATRIXI_COEF32_40;
			MATRIXI_COEF41_42 = T3X_VDIN1_HDR2_MATRIXI_COEF41_42;
			MATRIXI_OFFSET0_1 = T3X_VDIN1_HDR2_MATRIXI_OFFSET0_1;
			MATRIXI_OFFSET2 = T3X_VDIN1_HDR2_MATRIXI_OFFSET2;
			MATRIXI_PRE_OFFSET0_1 = T3X_VDIN1_HDR2_MATRIXI_PRE_OFFSET0_1;
			MATRIXI_PRE_OFFSET2 = T3X_VDIN1_HDR2_MATRIXI_PRE_OFFSET2;
			MATRIXI_CLIP = T3X_VDIN1_HDR2_MATRIXI_CLIP;
			MATRIXI_EN_CTRL = T3X_VDIN1_HDR2_MATRIXI_EN_CTRL;

			MATRIXO_COEF00_01 = T3X_VDIN1_HDR2_MATRIXO_COEF00_01;
			MATRIXO_COEF00_01 = T3X_VDIN1_HDR2_MATRIXO_COEF00_01;
			MATRIXO_COEF02_10 = T3X_VDIN1_HDR2_MATRIXO_COEF02_10;
			MATRIXO_COEF11_12 = T3X_VDIN1_HDR2_MATRIXO_COEF11_12;
			MATRIXO_COEF20_21 = T3X_VDIN1_HDR2_MATRIXO_COEF20_21;
			MATRIXO_COEF22 = T3X_VDIN1_HDR2_MATRIXO_COEF22;
			MATRIXO_COEF30_31 = T3X_VDIN1_HDR2_MATRIXO_COEF30_31;
			MATRIXO_COEF32_40 = T3X_VDIN1_HDR2_MATRIXO_COEF32_40;
			MATRIXO_COEF41_42 = T3X_VDIN1_HDR2_MATRIXO_COEF41_42;
			MATRIXO_OFFSET0_1 = T3X_VDIN1_HDR2_MATRIXO_OFFSET0_1;
			MATRIXO_OFFSET2 = T3X_VDIN1_HDR2_MATRIXO_OFFSET2;
			MATRIXO_PRE_OFFSET0_1 = T3X_VDIN1_HDR2_MATRIXO_PRE_OFFSET0_1;
			MATRIXO_PRE_OFFSET2 = T3X_VDIN1_HDR2_MATRIXO_PRE_OFFSET2;
			MATRIXO_CLIP = T3X_VDIN1_HDR2_MATRIXO_CLIP;
			MATRIXO_EN_CTRL = T3X_VDIN1_HDR2_MATRIXO_EN_CTRL;

			CGAIN_OFFT = T3X_VDIN1_HDR2_CGAIN_OFFT;
			CGAIN_COEF0 = T3X_VDIN1_HDR2_CGAIN_COEF0;
			CGAIN_COEF1 = T3X_VDIN1_HDR2_CGAIN_COEF1;
			ADPS_CTRL = T3X_VDIN1_HDR2_ADPS_CTRL;
			ADPS_ALPHA0 = T3X_VDIN1_HDR2_ADPS_ALPHA0;
			ADPS_ALPHA1 = T3X_VDIN1_HDR2_ADPS_ALPHA1;
			ADPS_BETA0 = T3X_VDIN1_HDR2_ADPS_BETA0;
			ADPS_BETA1 = T3X_VDIN1_HDR2_ADPS_BETA1;
			ADPS_BETA2 = T3X_VDIN1_HDR2_ADPS_BETA2;
			ADPS_COEF0 = T3X_VDIN1_HDR2_ADPS_COEF0;
			ADPS_COEF1 = T3X_VDIN1_HDR2_ADPS_COEF1;
			GMUT_CTRL = T3X_VDIN1_HDR2_GMUT_CTRL;
			GMUT_COEF0 = T3X_VDIN1_HDR2_GMUT_COEF0;
			GMUT_COEF1 = T3X_VDIN1_HDR2_GMUT_COEF1;
			GMUT_COEF2 = T3X_VDIN1_HDR2_GMUT_COEF2;
			GMUT_COEF3 = T3X_VDIN1_HDR2_GMUT_COEF3;
			GMUT_COEF4 = T3X_VDIN1_HDR2_GMUT_COEF4;

			hdr_ctrl = T3X_VDIN1_HDR2_CTRL;
		} else {
	...
	} else if (module_sel == VDIN2_HDR) {
		MATRIXI_COEF00_01 = T3X_VDIN2_HDR2_MATRIXI_COEF00_01;
		MATRIXI_COEF00_01 = T3X_VDIN2_HDR2_MATRIXI_COEF00_01;
		MATRIXI_COEF02_10 = T3X_VDIN2_HDR2_MATRIXI_COEF02_10;
		MATRIXI_COEF11_12 = T3X_VDIN2_HDR2_MATRIXI_COEF11_12;
		MATRIXI_COEF20_21 = T3X_VDIN2_HDR2_MATRIXI_COEF20_21;
		MATRIXI_COEF22 = T3X_VDIN2_HDR2_MATRIXI_COEF22;
		MATRIXI_COEF30_31 = T3X_VDIN2_HDR2_MATRIXI_COEF30_31;
		MATRIXI_COEF32_40 = T3X_VDIN2_HDR2_MATRIXI_COEF32_40;
		MATRIXI_COEF41_42 = T3X_VDIN2_HDR2_MATRIXI_COEF41_42;
		MATRIXI_OFFSET0_1 = T3X_VDIN2_HDR2_MATRIXI_OFFSET0_1;
		MATRIXI_OFFSET2 = T3X_VDIN2_HDR2_MATRIXI_OFFSET2;
		MATRIXI_PRE_OFFSET0_1 = T3X_VDIN2_HDR2_MATRIXI_PRE_OFFSET0_1;
		MATRIXI_PRE_OFFSET2 = T3X_VDIN2_HDR2_MATRIXI_PRE_OFFSET2;
		MATRIXI_CLIP = T3X_VDIN2_HDR2_MATRIXI_CLIP;
		MATRIXI_EN_CTRL = T3X_VDIN2_HDR2_MATRIXI_EN_CTRL;

		MATRIXO_COEF00_01 = T3X_VDIN2_HDR2_MATRIXO_COEF00_01;
		MATRIXO_COEF00_01 = T3X_VDIN2_HDR2_MATRIXO_COEF00_01;
		MATRIXO_COEF02_10 = T3X_VDIN2_HDR2_MATRIXO_COEF02_10;
		MATRIXO_COEF11_12 = T3X_VDIN2_HDR2_MATRIXO_COEF11_12;
		MATRIXO_COEF20_21 = T3X_VDIN2_HDR2_MATRIXO_COEF20_21;
		MATRIXO_COEF22 = T3X_VDIN2_HDR2_MATRIXO_COEF22;
		MATRIXO_COEF30_31 = T3X_VDIN2_HDR2_MATRIXO_COEF30_31;
		MATRIXO_COEF32_40 = T3X_VDIN2_HDR2_MATRIXO_COEF32_40;
		MATRIXO_COEF41_42 = T3X_VDIN2_HDR2_MATRIXO_COEF41_42;
		MATRIXO_OFFSET0_1 = T3X_VDIN2_HDR2_MATRIXO_OFFSET0_1;
		MATRIXO_OFFSET2 = T3X_VDIN2_HDR2_MATRIXO_OFFSET2;
		MATRIXO_PRE_OFFSET0_1 = T3X_VDIN2_HDR2_MATRIXO_PRE_OFFSET0_1;
		MATRIXO_PRE_OFFSET2 = T3X_VDIN2_HDR2_MATRIXO_PRE_OFFSET2;
		MATRIXO_CLIP = T3X_VDIN2_HDR2_MATRIXO_CLIP;
		MATRIXO_EN_CTRL = T3X_VDIN2_HDR2_MATRIXO_EN_CTRL;

		CGAIN_OFFT = T3X_VDIN2_HDR2_CGAIN_OFFT;
		CGAIN_COEF0 = T3X_VDIN2_HDR2_CGAIN_COEF0;
		CGAIN_COEF1 = T3X_VDIN2_HDR2_CGAIN_COEF1;
		ADPS_CTRL = T3X_VDIN2_HDR2_ADPS_CTRL;
		ADPS_ALPHA0 = T3X_VDIN2_HDR2_ADPS_ALPHA0;
		ADPS_ALPHA1 = T3X_VDIN2_HDR2_ADPS_ALPHA1;
		ADPS_BETA0 = T3X_VDIN2_HDR2_ADPS_BETA0;
		ADPS_BETA1 = T3X_VDIN2_HDR2_ADPS_BETA1;
		ADPS_BETA2 = T3X_VDIN2_HDR2_ADPS_BETA2;
		ADPS_COEF0 = T3X_VDIN2_HDR2_ADPS_COEF0;
		ADPS_COEF1 = T3X_VDIN2_HDR2_ADPS_COEF1;
		GMUT_CTRL = T3X_VDIN2_HDR2_GMUT_CTRL;
		GMUT_COEF0 = T3X_VDIN2_HDR2_GMUT_COEF0;
		GMUT_COEF1 = T3X_VDIN2_HDR2_GMUT_COEF1;
		GMUT_COEF2 = T3X_VDIN2_HDR2_GMUT_COEF2;
		GMUT_COEF3 = T3X_VDIN2_HDR2_GMUT_COEF3;
		GMUT_COEF4 = T3X_VDIN2_HDR2_GMUT_COEF4;

		hdr_ctrl = T3X_VDIN2_HDR2_CTRL;
		vpp_sel = 0xff;
		/* hdr_clk_gate = VDIN1_HDR2_CLK_GATE; */
	}
	...
	pr_csc(64, "hdr: mtx_param addr = %x, on = %d, vsel = %d, msel= %d\n",
		hdr_ctrl, hdr_mtx_param->mtx_on, vpp_sel, module_sel);
...
//#endif
		...
		VSYNC_WRITE_VPP_REG_BITS_VPP_SEL(hdr_ctrl,
			hdr_mtx_param->mtx_only, 16, 1, vpp_sel);
		  ...
		  enum vpp_index_e vpp_index)
{
	...
	if (module_sel == VD1_HDR) {
		...
		eotf_lut_addr_port = T3X_OSD2_EOTF_LUT_ADDR_PORT;
		eotf_lut_data_port = T3X_OSD2_EOTF_LUT_DATA_PORT;
		hdr_ctrl = T3X_OSD2_HDR2_CTRL;
	} else if (module_sel == VDIN0_HDR) {
		eotf_lut_addr_port = T3X_VDIN0_EOTF_LUT_ADDR_PORT;
		eotf_lut_data_port = T3X_VDIN0_EOTF_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN0_HDR2_CTRL;
		vpp_sel = 0xff;
	} else if (module_sel == VDIN1_HDR) {
		if (is_meson_t3x_cpu()) {
			eotf_lut_addr_port = T3X_VDIN1_EOTF_LUT_ADDR_PORT;
			eotf_lut_data_port = T3X_VDIN1_EOTF_LUT_DATA_PORT;
			hdr_ctrl = T3X_VDIN1_HDR2_CTRL;
		} else {
		...
		eotf_lut_addr_port = T3X_VDIN2_EOTF_LUT_ADDR_PORT;
		eotf_lut_data_port = T3X_VDIN2_EOTF_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN2_HDR2_CTRL;
		vpp_sel = 0xff;
	}
		  ...
		  enum vpp_index_e vpp_index)
{
	...
	if (module_sel == VD1_HDR) {
		...
		ootf_lut_addr_port = T3X_OSD2_OGAIN_LUT_ADDR_PORT;
		ootf_lut_data_port = T3X_OSD2_OGAIN_LUT_DATA_PORT;
		hdr_ctrl = T3X_OSD2_HDR2_CTRL;
	} else if (module_sel == VDIN0_HDR) {
		ootf_lut_addr_port = T3X_VDIN0_OGAIN_LUT_ADDR_PORT;
		ootf_lut_data_port = T3X_VDIN0_OGAIN_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN0_HDR2_CTRL;
		vpp_sel = 0xff;
	} else if (module_sel == VDIN1_HDR) {
		if (is_meson_t3x_cpu()) {
			ootf_lut_addr_port = T3X_VDIN1_OGAIN_LUT_ADDR_PORT;
			ootf_lut_data_port = T3X_VDIN1_OGAIN_LUT_DATA_PORT;
			hdr_ctrl = T3X_VDIN1_HDR2_CTRL;
		} else {
		...
		ootf_lut_addr_port = T3X_VDIN2_OGAIN_LUT_ADDR_PORT;
		ootf_lut_data_port = T3X_VDIN2_OGAIN_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN2_HDR2_CTRL;
		vpp_sel = 0xff;
	}
		  ...
		  enum vpp_index_e vpp_index)
{
	...
	if (module_sel == VD1_HDR) {
		...
		oetf_lut_addr_port = T3X_OSD2_OETF_LUT_ADDR_PORT;
		oetf_lut_data_port = T3X_OSD2_OETF_LUT_DATA_PORT;
		hdr_ctrl = T3X_OSD2_HDR2_CTRL;
	} else if (module_sel == VDIN0_HDR) {
		oetf_lut_addr_port = T3X_VDIN0_OETF_LUT_ADDR_PORT;
		oetf_lut_data_port = T3X_VDIN0_OETF_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN0_HDR2_CTRL;
		vpp_sel = 0xff;
	} else if (module_sel == VDIN1_HDR) {
		if (is_meson_t3x_cpu()) {
			oetf_lut_addr_port = T3X_VDIN1_OETF_LUT_ADDR_PORT;
			oetf_lut_data_port = T3X_VDIN1_OETF_LUT_DATA_PORT;
			hdr_ctrl = T3X_VDIN1_HDR2_CTRL;
		} else {
		...
		oetf_lut_addr_port = T3X_VDIN2_OETF_LUT_ADDR_PORT;
		oetf_lut_data_port = T3X_VDIN2_OETF_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN2_HDR2_CTRL;
		vpp_sel = 0xff;
	}
		...
		enum vpp_index_e vpp_index)
{
	...
	if (module_sel == VD1_HDR) {
		...
		cgain_lut_addr_port = T3X_OSD2_CGAIN_LUT_ADDR_PORT;
		cgain_lut_data_port = T3X_OSD2_CGAIN_LUT_DATA_PORT;
		hdr_ctrl = T3X_OSD2_HDR2_CTRL;
		cgain_coef1 = T3X_OSD2_HDR2_CGAIN_COEF1;
	} else if (module_sel == VDIN0_HDR) {
		cgain_lut_addr_port = T3X_VDIN0_CGAIN_LUT_ADDR_PORT;
		cgain_lut_data_port = T3X_VDIN0_CGAIN_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN0_HDR2_CTRL;
		cgain_coef1 = T3X_VDIN0_HDR2_CGAIN_COEF1;
		vpp_sel = 0xff;
	} else if (module_sel == VDIN1_HDR) {
		if (is_meson_t3x_cpu()) {
			cgain_lut_addr_port = T3X_VDIN1_CGAIN_LUT_ADDR_PORT;
			cgain_lut_data_port = T3X_VDIN1_CGAIN_LUT_DATA_PORT;
			hdr_ctrl = T3X_VDIN1_HDR2_CTRL;
			cgain_coef1 = T3X_VDIN1_HDR2_CGAIN_COEF1;
		} else {
		...
		cgain_lut_addr_port = T3X_VDIN2_CGAIN_LUT_ADDR_PORT;
		cgain_lut_data_port = T3X_VDIN2_CGAIN_LUT_DATA_PORT;
		hdr_ctrl = T3X_VDIN2_HDR2_CTRL;
		cgain_coef1 = T3X_VDIN2_HDR2_CGAIN_COEF1;
		vpp_sel = 0xff;
	}
	...
	enum vpp_index_e vpp_index)
{
	...
	if (module_sel == VD1_HDR) {
		...
		hist_ctrl = T3X_OSD2_HDR2_HIST_CTRL;
		hist_hs_he = T3X_OSD2_HDR2_HIST_H_START_END;
		hist_vs_ve = T3X_OSD2_HDR2_HIST_V_START_END;
	} else if (module_sel == VDIN0_HDR) {
		hist_ctrl = T3X_VDIN0_HDR2_HIST_CTRL;
		hist_hs_he = T3X_VDIN0_HDR2_HIST_H_START_END;
		hist_vs_ve = T3X_VDIN0_HDR2_HIST_V_START_END;
		vpp_sel = 0xff;
	} else if (module_sel == VDIN1_HDR) {
		if (is_meson_t3x_cpu()) {
			hist_ctrl = T3X_VDIN1_HDR2_HIST_CTRL;
			hist_hs_he = T3X_VDIN1_HDR2_HIST_H_START_END;
			hist_vs_ve = T3X_VDIN1_HDR2_HIST_V_START_END;
		} else {
		...
		hist_ctrl = T3X_VDIN2_HDR2_HIST_CTRL;
		hist_hs_he = T3X_VDIN2_HDR2_HIST_H_START_END;
		hist_vs_ve = T3X_VDIN2_HDR2_HIST_V_START_END;
		vpp_sel = 0xff;
	} else {
		return;
	}
...
{
	WRITE_VPP_REG(S5_VD1_HDR2_HIST_CTRL, 0x5510);
	WRITE_VPP_REG(S5_VD1_HDR2_HIST_H_START_END, 0x10000);
	WRITE_VPP_REG(S5_VD1_HDR2_HIST_V_START_END, 0x0);

	WRITE_VPP_REG(S5_VD1_SLICE1_HDR2_HIST_CTRL, 0x5510);
	WRITE_VPP_REG(S5_VD1_SLICE1_HDR2_HIST_H_START_END, 0x10000);
	WRITE_VPP_REG(S5_VD1_SLICE1_HDR2_HIST_V_START_END, 0x0);

	WRITE_VPP_REG(S5_VD2_HDR2_HIST_CTRL, 0x5510);
	WRITE_VPP_REG(S5_VD2_HDR2_HIST_H_START_END, 0x10000);
	WRITE_VPP_REG(S5_VD2_HDR2_HIST_V_START_END, 0x0);

	WRITE_VPP_REG(S5_OSD1_HDR2_HIST_CTRL, 0x5510);
	WRITE_VPP_REG(S5_OSD1_HDR2_HIST_H_START_END, 0x10000);
	WRITE_VPP_REG(S5_OSD1_HDR2_HIST_V_START_END, 0x0);
}
