...
static const struct cpu_dyn_table tm2_cpu_dyn_table[] = {
...
static const struct clk_parent_data tm2_cpu_dyn_clk_sel[] = {
	{ .fw_name = "xtal", },
	{ .hw = &tm2_fclk_div2.hw },
	{ .hw = &tm2_fclk_div3.hw },
	{ .hw = &tm2_gp1_pll.hw },
...
static struct clk_regmap tm2_cpu_dyn_clk = {
	.data = &(struct meson_clk_cpu_dyn_data){
		.table = tm2_cpu_dyn_table,
		.table_cnt = ARRAY_SIZE(tm2_cpu_dyn_table),
		.offset = HHI_SYS_CPU_CLK_CNTL0,
	},
	.hw.init = &(struct clk_init_data){
		.name = "cpu_dyn_clk",
		.ops = &meson_clk_cpu_dyn_ops,
		.parent_data = tm2_cpu_dyn_clk_sel,
		.num_parents = ARRAY_SIZE(tm2_cpu_dyn_clk_sel),
	},
};
...
static const struct cpu_dyn_table tm2_dsu_dyn_table[] = {
	CPU_LOW_PARAMS(1000000000, 1, 0, 0),
	CPU_LOW_PARAMS(1200000000, 3, 0, 0),
	CPU_LOW_PARAMS(1500000000, 3, 0, 0)
};

static struct clk_regmap tm2_dsu_dyn_clk = {
	.data = &(struct meson_clk_cpu_dyn_data){
		.table = tm2_dsu_dyn_table,
		.table_cnt = ARRAY_SIZE(tm2_dsu_dyn_table),
...
static struct tm2_sys_pll_nb_data tm2_sys_pll_nb_data = {
	...
	.cpu_clk_dyn = &tm2_cpu_dyn_clk.hw,
...
static struct clk_hw_onecell_data tm2_hw_onecell_data = {
	.hws = {
		...
		[CLKID_CPU_CLK_DYN]		= &tm2_cpu_dyn_clk.hw,
