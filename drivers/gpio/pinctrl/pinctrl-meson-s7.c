...
#include <dt-bindings/gpio/meson-s7-gpio.h>
#include "pinctrl-meson.h"
#include "pinctrl-meson-axg-pmx.h"

static const struct pinctrl_pin_desc meson_s7_periphs_pins[] = {
	MESON_PIN(GPIOE_0),
	MESON_PIN(GPIOE_1),
...
/* Bank B func3 */
static const unsigned int spinf_rst_pins[]		= { GPIOB_2 };
...
static const unsigned int tdm_d3_d_pins[]		= { GPIOD_8 };
...
static const char * const spinf_groups[] = {
	"spinf_rst", "spinf_hold_d3", "spinf_mo_d0", "spinf_mi_d1",
	"spinf_clk", "spinf_wp_d2", "spinf_d4", "spinf_d5", "spinf_d6",
...
static struct meson_axg_pmx_data meson_s7_periphs_pmx_banks_data = {
	.pmx_banks	= meson_s7_periphs_pmx_banks,
	.num_pmx_banks	= ARRAY_SIZE(meson_s7_periphs_pmx_banks),
};

static struct meson_pinctrl_data meson_s7_periphs_pinctrl_data __refdata = {
	.name		= "periphs-banks",
	.pins		= meson_s7_periphs_pins,
	.groups		= meson_s7_periphs_groups,
	.funcs		= meson_s7_periphs_functions,
	.banks		= meson_s7_periphs_banks,
	.num_pins	= ARRAY_SIZE(meson_s7_periphs_pins),
...
static const struct of_device_id meson_s7_pinctrl_dt_match[] = {
	{
		...
		.data = &meson_s7_periphs_pinctrl_data,
	},
	{ },
};

static struct platform_driver meson_s7_pinctrl_driver = {
	.probe  = meson_pinctrl_probe,
	.driver = {
		.name	= "meson-s7-pinctrl",
	},
};

#ifndef MODULE
static int __init s7_pmx_init(void)
{
	meson_s7_pinctrl_driver.driver.of_match_table =
			meson_s7_pinctrl_dt_match;
	return platform_driver_register(&meson_s7_pinctrl_driver);
}
...
module_init(meson_s7_pinctrl_init);
#endif
