...
static struct sec_pm_private_domain s5_pm_domains[] = {
	...
	[PDID_S5_MALI_1] = TOP_DOMAIN(mali_1, PDID_S5_MALI_1,
			DOMAIN_INIT_OFF, 0, PDID_S5_MALI_TOP),
	[PDID_S5_MALI_2] = TOP_DOMAIN(mali_2, PDID_S5_MALI_2,
			DOMAIN_INIT_OFF, 0, PDID_S5_MALI_TOP),
	[PDID_S5_MALI_TOP] = POWER_DOMAIN(mali_top, PDID_S5_MALI_TOP,
			DOMAIN_INIT_OFF, 0),
	[PDID_S5_DOS_TOP_WRAP] = POWER_DOMAIN(dos_top_wrap, PDID_S5_DOS_TOP_WRAP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DOS_VDEC] = TOP_DOMAIN(dos_vdec, PDID_S5_DOS_VDEC,
			DOMAIN_INIT_OFF, 0, PDID_S5_DOS_TOP_WRAP),
	[PDID_S5_DOS_HCODEC] = TOP_DOMAIN(dos_hcode, PDID_S5_DOS_HCODEC,
			DOMAIN_INIT_OFF, 0, PDID_S5_DOS_TOP_WRAP),
	[PDID_S5_DOS_HEVC_TOP] = TOP_DOMAIN(dos_hevc_top, PDID_S5_DOS_HEVC_TOP,
			DOMAIN_INIT_OFF, 0, PDID_S5_DOS_TOP_WRAP),
	[PDID_S5_DOS_HEVC_CORE1] = TOP_DOMAIN(dos_hevc_core1, PDID_S5_DOS_HEVC_CORE1,
			DOMAIN_INIT_OFF, 0, PDID_S5_DOS_TOP_WRAP),
	[PDID_S5_USB2] = POWER_DOMAIN(usb2, PDID_S5_USB2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_PCIE0] = POWER_DOMAIN(pcie0, PDID_S5_PCIE0,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_GE2D] = TOP_DOMAIN(ge2d, PDID_S5_GE2D,
			DOMAIN_INIT_OFF, 0, PDID_S5_VGE_TOP),
	[PDID_S5_VC9000E] = TOP_DOMAIN(vc9000e, PDID_S5_VC9000E,
			DOMAIN_INIT_OFF, 0, PDID_S5_VGE_TOP),
	[PDID_S5_VICP] = TOP_DOMAIN(vicp, PDID_S5_VICP,
			DOMAIN_INIT_OFF, 0, PDID_S5_VGE_TOP),
	[PDID_S5_VGE_TOP] = POWER_DOMAIN(vge_top, PDID_S5_VGE_TOP,
			DOMAIN_INIT_OFF, 0),
	[PDID_S5_VI_CLK1] = TOP_DOMAIN(vi_clk1, PDID_S5_VI_CLK1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON, PDID_S5_VPU_HDMI),
	[PDID_S5_VI_CLK2] = TOP_DOMAIN(vi_clk2, PDID_S5_VI_CLK2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON, PDID_S5_VPU_HDMI),
	[PDID_S5_VPU_HDMI] = POWER_DOMAIN(vpu_hdmi, PDID_S5_VPU_HDMI,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_ETH] = POWER_DOMAIN(eth, PDID_S5_ETH,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_PCIE1] = POWER_DOMAIN(pcie1, PDID_S5_PCIE1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VPU_DOLBY] = TOP_DOMAIN(vpu_dolby, PDID_S5_VPU_DOLBY,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON, PDID_S5_VPU_HDMI),
	[PDID_S5_USB30] = POWER_DOMAIN(usb30, PDID_S5_USB30,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_USB31] = POWER_DOMAIN(usb31, PDID_S5_USB31,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_SDCARD] = POWER_DOMAIN(sdcard, PDID_S5_SDCARD,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_SDIO] = POWER_DOMAIN(sdio, PDID_S5_SDIO,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_NAND_EMMC] = POWER_DOMAIN(nand_emmc, PDID_S5_NAND_EMMC,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_NNA_4T] = POWER_DOMAIN(nna_4t, PDID_S5_NNA_4T,
			DOMAIN_INIT_OFF, 0),
	[PDID_S5_DMC00] = POWER_DOMAIN(dmc00, PDID_S5_DMC00,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DMC01] = POWER_DOMAIN(dmc01, PDID_S5_DMC01,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_NOC_DMC_TOP] = POWER_DOMAIN(dmc_top, PDID_S5_NOC_DMC_TOP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DMC10] = POWER_DOMAIN(dmc10, PDID_S5_DMC10,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DMC11] = POWER_DOMAIN(dmc11, PDID_S5_DMC11,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DDRPHY0] = POWER_DOMAIN(ddrphy0, PDID_S5_DDRPHY0,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DDRPHY1] = POWER_DOMAIN(ddrphy1, PDID_S5_DDRPHY1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
};

static struct sec_pm_domain_data s5_pm_domain_data = {
	.domains = s5_pm_domains,
...
static struct sec_pm_private_domain t3x_pm_domains[] = {
	[PDID_T3X_DSPA] = POWER_DOMAIN(dspa, PDID_T3X_DSPA,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_MALI_0] = POWER_DOMAIN(mali0, PDID_T3X_MALI_0,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_MALI_1] = POWER_DOMAIN(mali1, PDID_T3X_MALI_1,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_MALI_2] = POWER_DOMAIN(mali2, PDID_T3X_MALI_2,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_DOS_VDEC] = POWER_DOMAIN(vdec, PDID_T3X_DOS_VDEC,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_DOS_HCODEC] = POWER_DOMAIN(hcodec,
			PDID_T3X_DOS_HCODEC, DOMAIN_INIT_OFF, 0),
	[PDID_T3X_DOS_HEVC_TOP] = POWER_DOMAIN(hevc, PDID_T3X_DOS_HEVC_TOP,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_USB2HX2] = POWER_DOMAIN(usb2hx2, PDID_T3X_USB2HX2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_GE2D] = POWER_DOMAIN(ge2d, PDID_T3X_GE2D,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_VICP] = POWER_DOMAIN(vicp, PDID_T3X_VICP,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_VI_CLK1] = POWER_DOMAIN(clk1, PDID_T3X_VI_CLK1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_VI_CLK2] = POWER_DOMAIN(clk2, PDID_T3X_VI_CLK2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_VPU_DOLBY] = POWER_DOMAIN(dolby, PDID_T3X_VPU_DOLBY,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_VPU_HDMI] = POWER_DOMAIN(hdmi, PDID_T3X_VPU_HDMI,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_ETH] = POWER_DOMAIN(eth, PDID_T3X_ETH,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_PCIE] = POWER_DOMAIN(pcie, PDID_T3X_PCIE,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_USB30] = POWER_DOMAIN(usb30, PDID_T3X_USB30,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_USB31] = POWER_DOMAIN(usb31, PDID_T3X_USB31,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_SDCARD] = POWER_DOMAIN(sdcard, PDID_T3X_SDCARD,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_NAND_EMMC] = POWER_DOMAIN(emmc, PDID_T3X_NAND_EMMC,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_NNA_4T] = POWER_DOMAIN(nna, PDID_T3X_NNA_4T,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_FRC_TOP] = POWER_DOMAIN(frc, PDID_T3X_FRC_TOP,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_HDMIRX_WRAP] = POWER_DOMAIN(hdmirx, PDID_T3X_HDMIRX_WRAP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_DEMOD] = POWER_DOMAIN(demo, PDID_T3X_DEMOD,
			DOMAIN_INIT_OFF, 0),
	[PDID_T3X_AUDIO] = POWER_DOMAIN(audio, PDID_T3X_AUDIO,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_DMC00] = POWER_DOMAIN(dmc00, PDID_T3X_DMC00,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_NOC_DMC_TOP] = POWER_DOMAIN(dmctop, PDID_T3X_NOC_DMC_TOP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_T3X_DMC10] = POWER_DOMAIN(dmc27, PDID_T3X_DMC10,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
};

static struct sec_pm_domain_data t3x_pm_domain_data = {
...
static struct sec_pm_private_domain txhd2_pm_domains[] __initdata = {
	[PDID_VPU] = POWER_DOMAIN(vpu, PDID_VPU, DOMAIN_INIT_ON,
					GENPD_FLAG_ALWAYS_ON),
	[PDID_DOS_HEVC] = POWER_DOMAIN(hevc, PDID_DOS_HEVC, DOMAIN_INIT_OFF,
				       0),
