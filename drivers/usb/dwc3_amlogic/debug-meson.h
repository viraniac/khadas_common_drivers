...
/*
 * debug-meson.h - DesignWare USB3 DRD Controller Debug Header
 *
...
#ifndef __DWC3_DEBUG_MESON_H
#define __DWC3_DEBUG_MESON_H
 ...
 */
static inline const char *
dwc3_gadget_link_string(enum aml_dwc3_link_state link_state)
{
	switch (link_state) {
 ...
 */
static inline const char *
dwc3_gadget_hs_link_string(enum aml_dwc3_link_state link_state)
{
	switch (link_state) {
	case DWC3_LINK_STATE_U0:
		return "On";
...
static inline const char *dwc3_ep0_state_string(enum aml_dwc3_ep0_state state)
{
	switch (state) {
...
{
	enum aml_dwc3_link_state state = event->event_info & DWC3_LINK_STATE_MASK;
...
static inline const char *dwc3_ep_event_string(char *str, size_t size,
		const struct aml_dwc3_event_depevt *event, u32 ep0state)
{
...
extern void aml_dwc3_debugfs_create_endpoint_dir(struct aml_dwc3_ep *dep);
extern void aml_dwc3_debugfs_remove_endpoint_dir(struct aml_dwc3_ep *dep);
extern void aml_dwc3_debugfs_init(struct aml_dwc3 *d);
extern void aml_dwc3_debugfs_exit(struct aml_dwc3 *d);
#else
static inline void aml_dwc3_debugfs_create_endpoint_dir(struct aml_dwc3_ep *dep)
{  }
static inline void aml_dwc3_debugfs_remove_endpoint_dir(struct aml_dwc3_ep *dep)
{  }
static inline void aml_dwc3_debugfs_init(struct aml_dwc3 *d)
{  }
static inline void aml_dwc3_debugfs_exit(struct aml_dwc3 *d)
{  }
#endif
