...
#ifndef __LINUX_XHCI_DEBUGFS_MESON_H
#define __LINUX_XHCI_DEBUGFS_MESON_H
...
struct aml_xhci_file_map {
	const char		*name;
	int			(*show)(struct seq_file *s, void *unused);
};

struct aml_xhci_ep_priv {
	char			name[DEBUGFS_NAMELEN];
	struct dentry		*root;
	struct aml_xhci_stream_info *stream_info;
	struct aml_xhci_ring	*show_ring;
	unsigned int		stream_id;
};

struct aml_xhci_slot_priv {
	char			name[DEBUGFS_NAMELEN];
	struct dentry		*root;
	struct aml_xhci_ep_priv	*eps[31];
...
void aml_xhci_debugfs_create_stream_files(struct aml_xhci_hcd *xhci,
				      ...
				      int ep_index);
#else
static inline void aml_xhci_debugfs_init(struct aml_xhci_hcd *xhci) { }
static inline void aml_xhci_debugfs_exit(struct aml_xhci_hcd *xhci) { }
static inline void __init aml_xhci_debugfs_create_root(void) { }
static inline void __exit aml_xhci_debugfs_remove_root(void) { }
static inline void aml_xhci_debugfs_create_slot(struct aml_xhci_hcd *x, int s) { }
static inline void aml_xhci_debugfs_remove_slot(struct aml_xhci_hcd *x, int s) { }
static inline void
aml_xhci_debugfs_create_endpoint(struct aml_xhci_hcd *xhci,
			     struct aml_xhci_virt_device *virt_dev,
			     int ep_index) { }
static inline void
aml_xhci_debugfs_remove_endpoint(struct aml_xhci_hcd *xhci,
			     struct aml_xhci_virt_device *virt_dev,
			     int ep_index) { }
static inline void
aml_xhci_debugfs_create_stream_files(struct aml_xhci_hcd *xhci,
				 struct aml_xhci_virt_device *virt_dev,
				 int ep_index) { }
